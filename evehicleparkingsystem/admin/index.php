...
function detectSQLInjection($input) {
    // patterns
    $pattern = "/(--|#|;|'|\"|\\/\\*|\\*\\/|\\bor\\b|\\band\\b|\\bselect\\b|\\binsert\\b|\\bupdate\\b|\\bdelete\\b|\\bdrop\\b|\\bunion\\b)/i";
...
if (isset($_POST['login'])) {
    ...
    if (detectSQLInjection($adminuser) || detectSQLInjection($password)) {
        print "<script>alert('No Hacking today Better luck next time bro!');</script>";
        error_log("Possible SQL injection attempt by user: $adminuser");
    } else {
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">E-Parking Management</h2>
                    </a>
                </div>
