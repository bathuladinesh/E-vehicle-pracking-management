...
echo "<script>window.location.href='manageOutgoingVehicle.php'</script>";
          }
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manageOutgoingVehicle.php">Manage Vehicle</a></li>
...
?>
                ...
                <tr>
                  ...
                  <td><a href="viewOutgoingVehicle.php?viewid=<?php echo $row['ID'];?>" class="btn btn-primary">View</a> 
<a href="print.php?vid=<?php echo $row['ID'];?>" style="cursor:pointer" target="_blank" class="btn btn-warning">Print</a>
<a href="manageOutgoingVehicle.php?del=<?php echo $row['ID'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
